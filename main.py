...
if None not in f and button:
    ...
    Model=pickle.load(open('C:/Users/ssoba/Downloads/SRM-main/SRM-main/LinearModel.pkl','rb'))
    ...
    st.image("C:/Users/ssoba/Downloads/SRM-main/SRM-main/plane.gif",width=200,caption="Happy Traveling!",use_column_width=True)
    ...
    img = get_img_as_base64("C:/Users/ssoba/Downloads/SRM-main/SRM-main/flight.jpg")
    page_bg_img = f"""
    <style>
